...
const _hoisted_1$6 = { class: "qr-login" };
const _hoisted_2$6 = {
  key: 0,
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const emit2 = __emit;
    const qrDataUrl = /* @__PURE__ */ ref(null);
    const loading = /* @__PURE__ */ ref(true);
    const error = /* @__PURE__ */ ref("");
    onMounted(async () => {
      window.electronAPI.onEvent("whatsapp:qr", (qr) => {
        qrDataUrl.value = qr;
        loading.value = false;
        error.value = "";
      });
      ...
      window.electronAPI.onEvent("whatsapp:error", (msg) => {
        error.value = msg;
        loading.value = false;
      });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        ...
        ])) : loading.value ? (openBlock(), createElementBlock("div", _hoisted_4$4, "Conectando...")) : qrDataUrl.value ? (openBlock(), createElementBlock("div", _hoisted_5$4, [
          _cache[0] || (_cache[0] = createBaseVNode("h2", null, "Escaneie o QR Code", -1)),
          _cache[1] || (_cache[1] = createBaseVNode("p", null, "Abra o WhatsApp no celular e escaneie", -1)),
          createBaseVNode("img", {
            src: qrDataUrl.value,
            alt: "QR Code"
          }, null, 8, _hoisted_6$3)
        ])) : (openBlock(), createElementBlock("div", _hoisted_7$3, "Aguardando QR Code..."))
      ]);
    };
  }
});
...
const QRLogin = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-c9c85c6e"]]);
const _hoisted_1$5 = { class: "chat-list" };
const _hoisted_2$5 = { class: "list" };
const _hoisted_3$4 = ["onClick"];
const _hoisted_4$3 = { class: "avatar" };
const _hoisted_5$3 = { class: "info" };
const _hoisted_6$2 = { class: "name" };
const _hoisted_7$2 = { class: "last-msg" };
const _hoisted_8$2 = { class: "time" };
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function formatTime(timestamp) {
      if (!timestamp) return "";
      const d = new Date(typeof timestamp === "number" ? timestamp * 1e3 : timestamp);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        _cache[0] || (_cache[0] = createBaseVNode("div", { class: "search" }, [
        ...
        createBaseVNode("div", _hoisted_2$5, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.chats, (chat) => {
            return openBlock(), createElementBlock("div", {
              key: chat.id,
              class: normalizeClass(["chat-item", { selected: chat.id === __props.selectedId }]),
              onClick: ($event) => emit2("select", chat.id)
            }, [
              createBaseVNode("div", _hoisted_4$3, toDisplayString(getName(chat)[0].toUpperCase()), 1),
              createBaseVNode("div", _hoisted_5$3, [
                createBaseVNode("div", _hoisted_6$2, toDisplayString(getName(chat)), 1),
                createBaseVNode("div", _hoisted_7$2, toDisplayString(chat.lastMessage?.message?.conversation || chat.lastMessage?.text || chat.lastMessage || "..."), 1)
              ]),
              createBaseVNode("div", _hoisted_8$2, toDisplayString(formatTime(chat.lastMessage?.messageTimestamp || chat.lastTimestamp)), 1)
            ], 10, _hoisted_3$4);
          }), 128))
        ])
      ]);
...
const ChatList = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-00670463"]]);
const _hoisted_1$4 = { class: "message-view" };
const _hoisted_2$4 = { class: "header" };
const _hoisted_3$3 = { class: "name" };
const _hoisted_4$2 = { class: "messages" };
const _hoisted_5$2 = { class: "bubble" };
const _hoisted_6$1 = { class: "time" };
const _hoisted_7$1 = { class: "input-area" };
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function getText(msg) {
      return msg.message?.conversation || msg.message?.extendedTextMessage?.text || msg.message?.imageMessage?.caption || msg.text || "";
    }
    function isMine(msg) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("div", _hoisted_2$4, [
          createBaseVNode("span", _hoisted_3$3, toDisplayString(__props.chatName), 1)
        ]),
        createBaseVNode("div", _hoisted_4$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.messages, (msg) => {
            return openBlock(), createElementBlock("div", {
              key: msg.id || msg.key?.id,
              class: normalizeClass(["message", { mine: isMine(msg) }])
            }, [
              createBaseVNode("div", _hoisted_5$2, [
                createBaseVNode("p", null, toDisplayString(getText(msg)), 1),
                createBaseVNode("span", _hoisted_6$1, toDisplayString(formatTime(msg.messageTimestamp || msg.timestamp)), 1)
              ])
            ], 2);
          }), 128))
        ]),
        createBaseVNode("div", _hoisted_7$1, [
          ...
          }, "Enviar", 8, _hoisted_8$1)
        ])
      ]);
    };
  }
});
const MessageView = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-95726d9f"]]);
const _hoisted_1$3 = { class: "platform-view" };
const _hoisted_2$3 = {
  key: 0,
  class: "chat-area"
};
...
const prefix$1 = "whatsapp";
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "WhatsAppView",
  setup(__props) {
    const status = /* @__PURE__ */ ref("disconnected");
    const chats = /* @__PURE__ */ ref([]);
    const messages = /* @__PURE__ */ ref([]);
    const selectedChat = /* @__PURE__ */ ref(null);
    const selectedChatName = /* @__PURE__ */ ref("");
    ...
    function onMessage(msg) {
      if (msg.key?.remoteJid === selectedChat.value) {
        api.getMessages(selectedChat.value).then((m) => {
          messages.value = m;
        });
      }
    }
    function onChatsUpdated(updated) {
      chats.value = updated;
    }
    onMounted(async () => {
      window.electronAPI.onEvent(`${prefix$1}:connected`, onConnected);
      window.electronAPI.onEvent(`${prefix$1}:disconnected`, onDisconnected);
      window.electronAPI.onEvent(`${prefix$1}:message`, onMessage);
      window.electronAPI.onEvent(`${prefix$1}:chatsUpdated`, onChatsUpdated);
      status.value = await api.getStatus();
      if (status.value === "connected") loadChats();
    });
    onUnmounted(() => {
      window.electronAPI.removeListener(`${prefix$1}:connected`);
      window.electronAPI.removeListener(`${prefix$1}:disconnected`);
      window.electronAPI.removeListener(`${prefix$1}:message`);
      window.electronAPI.removeListener(`${prefix$1}:chatsUpdated`);
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        status.value === "connected" && chats.value.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createVNode(ChatList, {
            chats: chats.value,
            "selected-id": selectedChat.value ?? void 0,
            onSelect: selectChat
          }, null, 8, ["chats", "selected-id"]),
          selectedChat.value ? (openBlock(), createElementBlock("div", _hoisted_2$3, [
            createVNode(MessageView, {
              messages: messages.value,
              "chat-name": selectedChatName.value,
              onSend: sendMessage
            }, null, 8, ["messages", "chat-name"])
          ])) : (openBlock(), createElementBlock("div", _hoisted_3$2, [..._cache[0] || (_cache[0] = [
            createBaseVNode("p", null, "Selecione uma conversa", -1)
          ])]))
        ], 64)) : (openBlock(), createBlock(QRLogin, {
          key: 1,
          onConnected
        }))
      ]);
...
const WhatsAppView = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-895d083a"]]);
const _hoisted_1$2 = { class: "platform-view" };
const _hoisted_2$2 = {
  key: 0,
  class: "login-area"
};
const _hoisted_3$1 = { class: "login-form" };
const _hoisted_4$1 = {
  key: 0,
  class: "error"
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const messages = /* @__PURE__ */ ref([]);
    const selectedThread = /* @__PURE__ */ ref(null);
    const selectedThreadName = /* @__PURE__ */ ref("");
    ...
    function onThreadsUpdated(updated) {
      threads.value = updated;
    }
    function onMessage(msg) {
      if (msg.threadId === selectedThread.value) {
        api.getMessages(selectedThread.value).then((m) => {
          messages.value = m;
        });
      }
    }
    onMounted(async () => {
      window.electronAPI.onEvent(`${prefix}:connected`, () => {
        status.value = "connected";
        loadThreads();
      });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        status.value === "disconnected" ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
          createBaseVNode("div", _hoisted_3$1, [
            _cache[0] || (_cache[0] = createBaseVNode("h2", null, "Instagram", -1)),
            _cache[1] || (_cache[1] = createBaseVNode("p", null, "Abra uma janela de login do Instagram", -1)),
            _cache[2] || (_cache[2] = createBaseVNode("p", { class: "note" }, [
              createTextVNode("Uma janela do navegador vai abrir para você fazer login normalmente."),
              createBaseVNode("br"),
              createTextVNode("Funciona com qualquer tipo de conta (incluindo login via Facebook).")
            ], -1)),
            error.value ? (openBlock(), createElementBlock("p", _hoisted_4$1, toDisplayString(error.value), 1)) : createCommentVNode("", true),
            createBaseVNode("button", {
              onClick: handleLogin,
              disabled: loading.value
            }, toDisplayString(loading.value ? "Abrindo janela..." : "Abrir login no navegador"), 9, _hoisted_5$1)
          ])
        ])) : (openBlock(), createElementBlock("div", _hoisted_6, [
          createVNode(ChatList, {
            chats: threads.value,
            "selected-id": selectedThread.value ?? void 0,
            onSelect: selectThread
          }, null, 8, ["chats", "selected-id"]),
          selectedThread.value ? (openBlock(), createElementBlock("div", _hoisted_7, [
            createVNode(MessageView, {
              messages: messages.value,
              "chat-name": selectedThreadName.value,
              onSend: sendMessage
            }, null, 8, ["messages", "chat-name"])
...
const InstagramView = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-174a781e"]]);
const routes = [
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const waStatus = /* @__PURE__ */ ref("disconnected");
    const igStatus = /* @__PURE__ */ ref("disconnected");
    const links = [
    ...
    onMounted(() => {
      ...
      window.electronAPI.onEvent("whatsapp:disconnected", () => {
        waStatus.value = "disconnected";
      });
      window.electronAPI.onEvent("instagram:connected", () => {
        igStatus.value = "connected";
      });
      window.electronAPI.onEvent("instagram:disconnected", () => {
        igStatus.value = "disconnected";
      });
      window.electronAPI.whatsapp.getStatus().then((s) => {
        waStatus.value = s;
      });
      window.electronAPI.instagram.getStatus().then((s) => {
        igStatus.value = s;
      });
    });
    onUnmounted(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("aside", _hoisted_1$1, [
        _cache[1] || (_cache[1] = createBaseVNode("div", { class: "logo" }, "MM", -1)),
        createBaseVNode("nav", null, [
          (openBlock(), createElementBlock(Fragment, null, renderList(links, (link) => {
            return createBaseVNode("button", {
              key: link.path,
              class: normalizeClass({ active: unref(route).path === link.path }),
              onClick: ($event) => unref(router2).push(link.path)
            }, [
              createBaseVNode("span", _hoisted_3, toDisplayString(link.icon), 1),
              createBaseVNode("span", _hoisted_4, toDisplayString(link.label), 1),
              createBaseVNode("span", {
                class: "dot",
                style: normalizeStyle({ background: statusColor(link.status.value) })
              }, null, 4)
            ], 10, _hoisted_2$1);
          }), 64))
        ]),
        createBaseVNode("div", _hoisted_5, [
          createBaseVNode("button", {
            class: "refresh-btn",
            onClick: _cache[0] || (_cache[0] = ($event) => _ctx.window.electronAPI.app.reload())
          }, " Recarregar ")
        ])
      ]);
    };
...
const Sidebar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8681ee75"]]);
